...
export default function PerformanceFamilyPage() {
  ...
  const fetchPerformanceData = async () => {
    setIsLoading(true)
    try {
      const response = await fetch(`/api/bh/performance?type=family`)
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Performance - Chambres Family</h1>
          <p className="text-gray-600">Analyse des performances des chambres family</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Évolution du prix moyen des chambres family</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data}>
